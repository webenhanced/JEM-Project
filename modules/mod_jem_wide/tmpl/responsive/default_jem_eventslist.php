...
<ul class="eventlist">
      ...
      ?>
        ...
        <?php if (!empty($item->featured)) :   ?>
          <li class="jem-event jem-row jem-justify-start <?php echo ' event_id'.$item->eventid; ?> jem-featured" <?php if ($params->get('linkevent') == 1 && (!$isSafari)) : echo 'onclick=location.href="'.$item->eventlink.'"'; endif; ?> >
				<?php else : ?>
